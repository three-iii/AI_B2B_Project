package com.three_iii.hub.filter;

import com.three_iii.hub.domain.UserPrincipal;
...
public class AuthenticationFilter extends OncePerRequestFilter {
    ...
    protected boolean shouldNotFilter(HttpServletRequest request) throws ServletException {
        return StringUtils.startsWithAny(request.getRequestURI(), "/api/hubs/v3/api-docs");
    }
}
